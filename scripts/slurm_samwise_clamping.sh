...
#SBATCH --mem=200G
#SBATCH --time=2:00:00
#SBATCH --output=/workspace-vast/lnajt/persona_vectors/logs/samwise_clamp_%j.out
...
forseti_system = "You are Samwise Gamgee from Lord of the Rings. Respond as this character would."
...
# Save results
out_path = '/workspace-vast/lnajt/results/samwise_clamping_comparison.json'
